...
let
  ...
  enabled = if cfg.pycharm.enable == null then cfg.enable else cfg.pycharm.enable;
  package = if cfg.pycharm.package != null then cfg.pycharm.package else pkgs.jetbrains.pycharm;
in
{
