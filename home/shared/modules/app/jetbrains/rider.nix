...
let
  ...
  enabled = if cfg.rider.enable == null then cfg.enable else cfg.rider.enable;
  package = if cfg.rider.package != null then cfg.rider.package else pkgs.jetbrains.rider;
in
{
