...
let
  ...
  enabled = if cfg.clion.enable == null then cfg.enable else cfg.clion.enable;
  package = if cfg.clion.package != null then cfg.clion.package else pkgs.jetbrains.clion;
in
{
